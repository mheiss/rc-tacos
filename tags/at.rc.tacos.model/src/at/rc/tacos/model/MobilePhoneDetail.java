...
public class MobilePhoneDetail extends AbstractMessage
{
	...
	/**
	 * Returns the calculated hash code based on the mobile phone id and the number<br>
	 * Two mobile phone entries have the same hash code if the id and the number is equal.
	 ...
	 * The mobile phone details are equal if, and only if, the id and the number is the same.
