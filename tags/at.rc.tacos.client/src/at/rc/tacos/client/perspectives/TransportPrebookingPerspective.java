...
public class TransportPrebookingPerspective implements IPerspectiveFactory 
{
    ...
    public void createInitialLayout(IPageLayout layout) 
    {
        ...
        layout.addStandaloneView(PrebookingView.ID,false, IPageLayout.RIGHT, 0.25f, editorArea);
        layout.addStandaloneView(FilterView.ID, false, IPageLayout.LEFT, 0.750f, editorArea);
    }
}
