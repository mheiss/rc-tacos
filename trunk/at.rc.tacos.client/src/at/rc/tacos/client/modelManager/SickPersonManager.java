...
public class SickPersonManager extends PropertyManager 
{
     ...
     * @param sick person the sick person to add
     */
     ...
     * @param sick person the sick person to remove
     */
     ...
     * @param sick person the sick person to update
     */
     ...
     * @param newsickPerson the sick person to check
     */
     ...
     * @param sickPerson id the id of the sickPerson to get the sickPerson
     */
