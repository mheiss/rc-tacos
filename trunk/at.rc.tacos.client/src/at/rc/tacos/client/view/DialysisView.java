...
public class DialysisView {
	...
	protected void createContents() {
		...
		final Button button_2 = new Button(transportdatenGroup, SWT.CHECK);
		button_2.setText("stationär");
		button_2.setBounds(41, 118, 85, 16);
		...
		final Text text_1_1 = new Text(planungGroup, SWT.BORDER);
		text_1_1.setBounds(41, 115, 41, 21);

		Group patientenzustandGroup;
		...
		final Button montagButton = new Button(patientenzustandGroup, SWT.CHECK);
		...
		final Button dienstagButton = new Button(patientenzustandGroup, SWT.CHECK);
		...
		final Button mittwochButton = new Button(patientenzustandGroup, SWT.CHECK);
		...
		final Button donnerstagButton = new Button(patientenzustandGroup, SWT.CHECK);
		...
		final Button freitagButton = new Button(patientenzustandGroup, SWT.CHECK);
		...
		final Button samstagButton = new Button(patientenzustandGroup, SWT.CHECK);
		...
		final Button sonntagButton = new Button(patientenzustandGroup, SWT.CHECK);
