...
import at.rc.tacos.client.view.composite.*;
...
public class VehiclesView extends ViewPart
{
    ...
    public void createPartControl(Composite parent) 
    {
        ...
        // Create the section for Kapfenberg and add the vehicles    
