...
public class VehicleForm extends TitleAreaDialog
{
	...
	// description text
	public final static String FORM_DESCRIPTION = "Hier kˆnnen Sie Fahrzeug und deren Besatzung verwalten";
	...
	private boolean checkRequiredFields()
	{
		...
		{
			setErrorMessage("Dem Fahrzeug wurde noch kein Sanit‰ter zugewiesen oder es fehlt ein Sanit‰ter.");
			readyButton.setSelection(false);
			return false;
		}
