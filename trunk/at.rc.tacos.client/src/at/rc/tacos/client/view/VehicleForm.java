...
public class VehicleForm extends TitleAreaDialog
{
    ...
    protected Control createContents(Composite parent) 
    {
        ...
        setMessage("Hier können Sie Fahrzeug und deren Besatzung verwalten", IMessageProvider.INFORMATION);
    ...
    private void createStatusSection(Composite parent)
    {
        ...
        outOfOrder.setText("Außer Dienst");
    }
    ...
    private boolean checkRequiredFields()
    {
        ...
        {
            setMessage("Das Fahrzeug hat noch keinen, oder es fehlt ein Sanitäter.", IMessageProvider.WARNING);
        }
