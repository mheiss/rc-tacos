...
/**Use TransportMainView instead of this
 */
...
// */
//
//public class TransportsMainView {
//
...
//		try {
//			TransportsMainView window = new TransportsMainView();
//			window.open();
//		} catch (Exception e) {
//			e.printStackTrace();
//		}
...
//
//		final TableColumn tableColumnPrioritaet = new TableColumn(table_4, SWT.NONE);
//		tableColumnPrioritaet.setToolTipText("C (Transport), D (Rücktransport), E (Heimtransport), F (Sonstiges)");
//		tableColumnPrioritaet.setWidth(31);
//		tableColumnPrioritaet.setText("Pr");
//
...
//
//		final TableColumn tableColumnErkrankungVerletzung = new TableColumn(table_4, SWT.NONE);
//		tableColumnErkrankungVerletzung.setToolTipText("Erkrankung Verletzung");
//		tableColumnErkrankungVerletzung.setWidth(126);
//		tableColumnErkrankungVerletzung.setText("Erkr/Verl");
//
//		final TableColumn tableColumnAnmerkung = new TableColumn(table_4, SWT.NONE);
//		tableColumnAnmerkung.setWidth(100);
//		tableColumnAnmerkung.setText("Anmerkung");
//
//		final TableColumn tableColumnSymbole = new TableColumn(table_4, SWT.NONE);
//		tableColumnSymbole.setWidth(146);
//		tableColumnSymbole.setText("Symbole");
//
...
//
//		final TableColumn tableColumnPrioritaet_1 = new TableColumn(table_4_1, SWT.NONE);
//		tableColumnPrioritaet_1.setToolTipText("C (Transport), D (Rücktransport), E (Heimtransport), F (Sonstiges)");
//		tableColumnPrioritaet_1.setWidth(31);
//		tableColumnPrioritaet_1.setText("Pr");
//
...
//
//		final TableColumn tableColumnErkrankungVerletzung_1 = new TableColumn(table_4_1, SWT.NONE);
//		tableColumnErkrankungVerletzung_1.setToolTipText("Erkrankung/Verletzung");
//		tableColumnErkrankungVerletzung_1.setWidth(126);
//		tableColumnErkrankungVerletzung_1.setText("Erkr/Verl");
//
//		final TableColumn tableColumnAnmerkung_1 = new TableColumn(table_4_1, SWT.NONE);
//		tableColumnAnmerkung_1.setWidth(100);
//		tableColumnAnmerkung_1.setText("Anmerkung");
//
//		final TableColumn tableColumnSymbole_1 = new TableColumn(table_4_1, SWT.NONE);
//		tableColumnSymbole_1.setWidth(146);
//		tableColumnSymbole_1.setText("Symbole");
//
...
//
//		final TableColumn tableColumnPrioritaet_2 = new TableColumn(table_4_2, SWT.NONE);
//		tableColumnPrioritaet_2.setToolTipText("C (Transport), D (Rücktransport), E (Heimtransport), F (Sonstiges)");
//		tableColumnPrioritaet_2.setWidth(31);
//		tableColumnPrioritaet_2.setText("Pr");
//
...
//
//		final TableColumn tableColumnErkrankungVerletzung_2 = new TableColumn(table_4_2, SWT.NONE);
//		tableColumnErkrankungVerletzung_2.setToolTipText("Erkrankung/Verletzung");
//		tableColumnErkrankungVerletzung_2.setWidth(126);
//		tableColumnErkrankungVerletzung_2.setText("Erkr/Verl");
//
//		final TableColumn tableColumnAnmerkung_2 = new TableColumn(table_4_2, SWT.NONE);
//		tableColumnAnmerkung_2.setWidth(100);
//		tableColumnAnmerkung_2.setText("Anmerkung");
//
//		final TableColumn tableColumnSymbole_2 = new TableColumn(table_4_2, SWT.NONE);
//		tableColumnSymbole_2.setWidth(146);
//		tableColumnSymbole_2.setText("Symbole");
//
...
//
//		final TableColumn tableColumnPrioritaet_4 = new TableColumn(table_4_4, SWT.NONE);
//		tableColumnPrioritaet_4.setToolTipText("C (Transport), D (Rücktransport), E (Heimtransport), F (Sonstiges)");
//		tableColumnPrioritaet_4.setWidth(31);
//		tableColumnPrioritaet_4.setText("Pr");
//
...
//
//		final TableColumn tableColumnErkrankungVerletzung_4 = new TableColumn(table_4_4, SWT.NONE);
//		tableColumnErkrankungVerletzung_4.setToolTipText("Erkrankung/Verletzung");
//		tableColumnErkrankungVerletzung_4.setWidth(126);
//		tableColumnErkrankungVerletzung_4.setText("Erkr/Verl");
//
//		final TableColumn tableColumnAnmerkung_4 = new TableColumn(table_4_4, SWT.NONE);
//		tableColumnAnmerkung_4.setWidth(100);
//		tableColumnAnmerkung_4.setText("Anmerkung");
//
//		final TableColumn tableColumnSymbole_4 = new TableColumn(table_4_4, SWT.NONE);
//		tableColumnSymbole_4.setWidth(146);
//		tableColumnSymbole_4.setText("Symbole");
//
...
//
//		final TableColumn tableColumnPrioritaet_5 = new TableColumn(table_4_5, SWT.NONE);
//		tableColumnPrioritaet_5.setToolTipText("C (Transport), D (Rücktransport), E (Heimtransport), F (Sonstiges)");
//		tableColumnPrioritaet_5.setWidth(31);
//		tableColumnPrioritaet_5.setText("Pr");
//
...
//
//		final TableColumn tableColumnErkrankungVerletzung_5 = new TableColumn(table_4_5, SWT.NONE);
//		tableColumnErkrankungVerletzung_5.setToolTipText("Erkrankung/Verletzung");
//		tableColumnErkrankungVerletzung_5.setWidth(126);
//		tableColumnErkrankungVerletzung_5.setText("Erkr/Verl");
//
//		final TableColumn tableColumnAnmerkung_5 = new TableColumn(table_4_5, SWT.NONE);
//		tableColumnAnmerkung_5.setWidth(100);
//		tableColumnAnmerkung_5.setText("Anmerkung");
//
//		final TableColumn tableColumnSymbole_5 = new TableColumn(table_4_5, SWT.NONE);
//		tableColumnSymbole_5.setWidth(146);
//		tableColumnSymbole_5.setText("Symbole");
//
...
//
//		final TableColumn tableColumnPrioritaet_3 = new TableColumn(table_4_3, SWT.NONE);
//		tableColumnPrioritaet_3.setToolTipText("C (Transport), D (Rücktransport), E (Heimtransport), F (Sonstiges)");
//		tableColumnPrioritaet_3.setWidth(31);
//		tableColumnPrioritaet_3.setText("Pr");
//
...
//
//		final TableColumn tableColumnErkrankungVerletzung_3 = new TableColumn(table_4_3, SWT.NONE);
//		tableColumnErkrankungVerletzung_3.setToolTipText("Erkrankung/Verletzung");
//		tableColumnErkrankungVerletzung_3.setWidth(126);
//		tableColumnErkrankungVerletzung_3.setText("Erkr/Verl");
//
//		final TableColumn tableColumnAnmerkung_3 = new TableColumn(table_4_3, SWT.NONE);
//		tableColumnAnmerkung_3.setWidth(100);
//		tableColumnAnmerkung_3.setText("Anmerkung");
//
//		final TableColumn tableColumnSymbole_3 = new TableColumn(table_4_3, SWT.NONE);
//		tableColumnSymbole_3.setWidth(146);
//		tableColumnSymbole_3.setText("Symbole");
//
