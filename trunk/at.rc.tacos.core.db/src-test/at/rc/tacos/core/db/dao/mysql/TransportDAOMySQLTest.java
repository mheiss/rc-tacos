...
public class TransportDAOMySQLTest extends DBTestBase
{
	...
	Transport  transport1 = new Transport("vonStraße1","vonStadt1",location1,MyUtils.stringToTimestamp("28-01-2008", MyUtils.dateFormat),MyUtils.stringToTimestamp("28-01-2008 12:00", MyUtils.timeAndDateFormat),"A",2);
	Transport  transport2 = new Transport("vonStraße2","vonStadt2",location1,MyUtils.stringToTimestamp("28-01-2008", MyUtils.dateFormat),MyUtils.stringToTimestamp("28-01-2008 14:00", MyUtils.timeAndDateFormat),"B",2);
...
//		deleteTable(CompetenceDAO.TABLE_NAME);
	...
	public void testInsertTransport()
	{
		...
		assertEquals("vonStraße3",transport4.getFromStreet());
