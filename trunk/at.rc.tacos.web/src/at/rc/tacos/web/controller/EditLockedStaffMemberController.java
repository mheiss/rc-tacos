 ...
 * @version 1.0
 */
public class EditLockedStaffMemberController extends Controller {
	...
	public Map<String, Object> handleRequest(HttpServletRequest request,
		...
		final List<AbstractMessage> staffMemberList = connection.sendListingRequest(StaffMember.ID, staffMemberLockedFilter);
