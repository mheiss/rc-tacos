...
public class LoginController implements Controller {
	...
	public Map<String, Object> doLogin(HttpServletRequest request, HttpServletResponse response, ServletContext context) throws Exception {
		...
		if (!client.connect(netBundle.getString("server.host"), Integer.parseInt(netBundle.getString("server.port"))))
			if (!client.connect(netBundle.getString("failover.host"), Integer.parseInt(netBundle.getString("failover.port")))) throw new IllegalArgumentException();
			else {
	...
	public Map<String, Object> doLogout(HttpServletRequest request, HttpServletResponse response, ServletContext context) throws Exception {
		...
		final Map<String, Object> params = new HashMap<String, Object>();
		session.invalidate();
		params.put("logout-success", "Sie haben sich erfolgreich ausgeloggt.");
		return params;
	}
	...
	public Map<String, Object> handleRequest(HttpServletRequest request, HttpServletResponse response, ServletContext context) throws Exception {
		...
		if ("login".equalsIgnoreCase(action)) {
			return doLogin(request, response, context);
