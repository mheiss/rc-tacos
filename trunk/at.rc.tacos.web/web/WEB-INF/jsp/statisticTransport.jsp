                        ...
                        <tr>
                            <td id="BlockContent">
                             <table width="100%" border="0"> <tr><td>
                                <% if(params.containsKey("statistic")){ 
                                   out.println(params.get("statistic"));
                                }else{
                                    out.println("Es konnte keine Statistik erstellt werden. Bitte versuchen Sie es zu einem sp&auml;teren Zeitpunkt weider.");
