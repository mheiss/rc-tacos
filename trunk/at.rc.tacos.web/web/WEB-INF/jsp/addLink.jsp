...
<c:choose>
	<c:when test="${params.addedCount gt 0}">
		<div id="submitSuccess">Sie&nbsp;haben&nbsp;einen&nbsp;neuen&nbsp;Link&nbsp;angelegt</div>
		<br />
	</c:when>
</c:choose>
...
<table class="standardForm">
	...
	<tr>
		<td colspan="2"><textarea name="title" cols="40"
			rows="7" wrap="soft">${params.title}</textarea></td>
		<td><span class="errorText"> <c:choose>
	...
	<tr>
		<td class="hButtonArea" colspan="3"><input type="submit"
			value="Link anlegen" /><input name="action" type="hidden"
			value="addLink" /></td>
	</tr>
</table>
</form>