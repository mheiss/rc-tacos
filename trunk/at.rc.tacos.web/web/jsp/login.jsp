		...
		<table cellpadding="0" border="0" cellspacing="0" width="800" align="center" id="mainTabLog">
			<tr>
				...
				<td align="right" valign="bottom" id="rightLogSite">
						...
						<%
							String meldung = (String)request.getAttribute("MELDUNG");
							if(meldung!=null)
							{
							%>
								<div id='meldungstext'>
					...
					<form  method="post" method="post" action="login"> 
						<table id="loginPanel">
		  					<tr><td align='right'>Username:</td><td align='left'><input type="text" name="username" size="20" id="username" value="<%if(meldung!=null){out.println((String)request.getAttribute("username"));} %>" ></td></tr>
		  				 	<tr><td align='right'>Password:</td><td align='left'><input type="password" name="password" size="20" maxlength="12" id="password" value="" ></td></tr>
