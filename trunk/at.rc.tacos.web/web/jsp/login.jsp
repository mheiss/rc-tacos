...
%>
		...
		<table cellpadding="0" border="0" cellspacing="0" width="800" align="center" id="mainTabLog">
			<tr>
				<td id="leftLogSite" align="left" valign="bottom"><a href="http://www.st.roteskreuz.at/">Rotes Kreuz Steiermark</a><br/><a href="<%=request.getContextPath()+"/Dispatcher/impressum.do"%>">Impressum</a></td>
