						...
						<tr>
							...
							<table width="100%" border="0">
								<tr>
									...
									<% current.add(Calendar.DAY_OF_MONTH, -1);%> <a
										href="<%=getServletContext().getContextPath()%>/Dispatcher/rosterDay.do?action=dayView&startDate=<%=formath.format(current.getTimeInMillis())%>"><img
										src="../image/Pfeil_links.jpg" alt="# " class="hidefocus"></a>
									</td>
									<td valign="middle" align="left"><%=formath.format(current.getTimeInMillis())%>
									</td>
									<td valign="middle" align="right">
									<% current.add(Calendar.DAY_OF_MONTH, +2);%><%=formath.format(current.getTimeInMillis())%>
									</td>
									<td valign="middle" align="right" width="20"><a
										href="<%=getServletContext().getContextPath()%>/Dispatcher/rosterDay.do?action=dayView&startDate=<%=formath.format(current.getTimeInMillis())%>"><img
										src="../image/Pfeil_rechts.jpg" alt="# " class="hidefocus"></a>
									</td>
								</tr>
							</table>
							...
							<table width="100%" border='0' cellpadding='0' cellspacing='0'>
								<tr>
									...
									<table width="100%" height="100%" border='0' cellpadding='0'
										cellspacing='0'>
										<tr>
											Wollen Sie den Dienst wirklich löschen?
											<% String action = request.getParameter("action");
										if ("doRemoveEntry".equalsIgnoreCase(action)) 
											{
											out.println("<a href=\"javascript:window.close()\">Abbrechen</a><br />"
											+ "<a href=\"<%=request.getContextPath()+\"/Dispatcher/rosterEntry.do?action=doRemoveEntry&id=\" + request.getParameter(\"id\")%>\"onclick=\"self.close()\">Ja</a>"); } else { out.println(""); } %>
										</tr>
									</table>
									</td>
								</tr>
