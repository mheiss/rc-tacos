...
public class ServiceTypeEditor extends EditorPart implements PropertyChangeListener
{
	...
	private void createManageSection(Composite parent)
	{
		...
		removeHyperlink.addHyperlinkListener(new HyperlinkAdapter()
		{
			...
			public void linkActivated(HyperlinkEvent e) 
			{
				...
				NetActivator.getDefault().sendRemoveMessage(ServiceType.ID,serviceType);
			}
		});
	...
	public void doSave(IProgressMonitor monitor) 
	{
		...
		if(isNew)
			NetActivator.getDefault().sendAddMessage(ServiceType.ID, serviceType);
		else
			NetActivator.getDefault().sendUpdateMessage(ServiceType.ID, serviceType);
	}
