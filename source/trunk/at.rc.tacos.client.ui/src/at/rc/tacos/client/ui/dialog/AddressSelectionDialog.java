...
public class AddressSelectionDialog extends SelectionStatusDialog implements DataChangeListener<Address> {
		...
		viewer.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(final SelectionChangedEvent event) {
				if (!event.getSelection().isEmpty())
					...
					updateStatus(new Status(IStatus.ERROR, UiWrapper.PLUGIN_ID, "Bitte w‰hlen Sie eine Adresse aus"));
			}
		});
	...
	public void dataChanged(Message<Address> message, MessageIoSession messageIoSession) {
		...
		updateStatus(new Status(IStatus.INFO, UiWrapper.PLUGIN_ID, ((Address) first).toString() + " ausgew‰hlt"));
	}
	...
	private void inputChanged() {
		...
		updateStatus(new Status(IStatus.INFO, UiWrapper.PLUGIN_ID, "Bitte w‰hlen Sie eine Addresse aus"));
