package at.rc.tacos.client.ui.wizard;
...
//import at.rc.tacos.client.ui.net.NetSource;
...
//		if(NetActivator.getDefault().isAuthenticated())
//			return true;
...
//			NetActivator.getDefault().init();
//			NetActivator.getDefault().sendLoginMessage(new Login(username,password,false));
//			getContainer().run(true, true, new IRunnableWithProgress() 
//			{
