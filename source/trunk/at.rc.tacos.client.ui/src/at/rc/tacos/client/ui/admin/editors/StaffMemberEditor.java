...
public class StaffMemberEditor extends EditorPart implements PropertyChangeListener
{
	...
	public void doSave(IProgressMonitor monitor) 
	{
		...
		if(isNew)
		{
			NetActivator.getDefault().sendAddMessage(Login.ID, loginInfo);
			NetActivator.getDefault().sendAddMessage(StaffMember.ID, staffMember);
		}
		else
		{
			NetActivator.getDefault().sendUpdateMessage(StaffMember.ID, staffMember);
			NetActivator.getDefault().sendUpdateMessage(Login.ID, loginInfo);
		}
	}
