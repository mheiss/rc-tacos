...
public class LoginSplashHandler extends AbstractSplashHandler {
	...
	private void loginDenied() {
		...
		MessageDialog.openError(getSplash(), "Anmeldung nicht erlaubt", login.getErrorMessage());
	}
	...
	private void handleButtonOKWidgetSelected() {
		...
		try {
			...
			MessageDialog.openInformation(getSplash(), "Anmeldung", "Sie müssen einen Benutzernamen und ein Passwort eingeben um sich anzumelden");
		}
	}
}
