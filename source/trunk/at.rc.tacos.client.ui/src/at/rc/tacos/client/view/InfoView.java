...
/**
 * The <code>InfoView</code> shows the {@link DayInfoMessage} and provides a {@link CDateTime}
 * instance to switch the date.
 * 
 * @author heissm
 */
public class InfoView extends ViewPart implements DataChangeListener<Object> {
    ...
    // the handler
    private DayInfoHandler dayInfoHandler = (DayInfoHandler) NetWrapper
            .getHandler(DayInfoMessage.class);
    ...
    private void updateInfoSection(MessageIoSession session) {
        if (session.isLoggedIn()) {
            ...
            date.setText(MyUtils.timestampToString(session.getLoginTime(),
                    MyUtils.timeAndDateFormat));
        } else {
    ...
    private void createInfoSection(Composite parent) {
        ...
        logoutLink.addHyperlinkListener(new HyperlinkAdapter() {
            ...
            public void linkActivated(HyperlinkEvent e) {
                MessageBox dialog = new MessageBox(getSite().getShell(), SWT.YES | SWT.NO
                        | SWT.ICON_QUESTION);
    ...
    private void createCalendarSection(Composite parent) {
        ...
        calendarSection.setLayoutData(new GridData(GridData.BEGINNING
        ...
        dateTime.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                ...
                GetMessage<RosterEntry> getRosterMessage = new GetMessage<RosterEntry>(
                        new RosterEntry());
                ...
                GetMessage<DayInfoMessage> getInfoMessage = new GetMessage<DayInfoMessage>(
                        new DayInfoMessage());
    ...
    private void createNotesSection(Composite parent) {
        ...
        saveDayInfoLink.addHyperlinkListener(new HyperlinkAdapter() {
            ...
            public void linkActivated(HyperlinkEvent e) {
                ...
                UpdateMessage<DayInfoMessage> updateMessage = new UpdateMessage<DayInfoMessage>(
                        dayInfo);
        ...
        noteEditor = new TextViewer(notesField, SWT.BORDER | SWT.FLAT | SWT.MULTI | SWT.WRAP
                | SWT.V_SCROLL);
    ...
    public void dataChanged(Message<Object> message, MessageIoSession messageIoSession) {
        ...
        if (object instanceof DayInfoMessage) {
            ...
            dayInfoSection.setText("Tagesinformationen für den "
                    + MyUtils.timestampToString(dayInfoMessage.getTimestamp(), MyUtils.dateFormat));
