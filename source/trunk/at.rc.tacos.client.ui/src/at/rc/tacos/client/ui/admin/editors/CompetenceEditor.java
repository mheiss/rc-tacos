...
public class CompetenceEditor extends EditorPart implements PropertyChangeListener
{
	...
	private void createManageSection(Composite parent)
	{
		...
		removeHyperlink.addHyperlinkListener(new HyperlinkAdapter()
		{
			...
			public void linkActivated(HyperlinkEvent e) 
			{
				...
				NetActivator.getDefault().sendRemoveMessage(Competence.ID,competence);
			}
		});
	...
	public void doSave(IProgressMonitor monitor) 
	{
		...
		if(isNew)
			NetActivator.getDefault().sendAddMessage(Competence.ID, competence);
		else
			NetActivator.getDefault().sendUpdateMessage(Competence.ID, competence);
	}
