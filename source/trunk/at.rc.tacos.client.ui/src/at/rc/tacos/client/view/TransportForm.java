...
public class TransportForm extends TitleAreaDialog implements DataChangeListener<Object> {
    ...
    private void createTransportSection(Composite parent) {
            ...
            public void widgetSelected(final SelectionEvent e) {
                if (Login.AUTH_ADMIN.equalsIgnoreCase(authorization)
                    ...
                    boolean cancelConfirmed = MessageDialog.openQuestion(PlatformUI.getWorkbench()
                            .getActiveWorkbenchWindow().getShell(), "Patient hinzufügen",
                            "Möchten Sie diesen Patienten zur Patientendatenbank hinzufügen?");
                    if (!cancelConfirmed)
                        return;
        ...
        timestampDF
                .setToolTipText("Zeitpunkt des letzten Anhakens des Dienstführenden/Insp.-Häkchens");
        ...
        timestampBRKDT
                .setToolTipText("Zeitpunkt des letzten Anhakens des Bezirksrettungskommandanten-Häkchens");
        ...
        timestampBergrettung
                .setToolTipText("Zeitpunkt des letzten Anhakens des Bergrettung-Häkchens");
        ...
        buttonVormerkung
                .setToolTipText("Blendet alle für eine Vormerkung nicht relevanten Felder aus");
