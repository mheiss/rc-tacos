...
public class DiseaseEditor extends EditorPart implements PropertyChangeListener
{
	...
	private void createManageSection(Composite parent)
	{
		...
		removeHyperlink.addHyperlinkListener(new HyperlinkAdapter()
		{
			...
			public void linkActivated(HyperlinkEvent e) 
			{
				...
				NetActivator.getDefault().sendRemoveMessage(Disease.ID,disease);
			}
		});
	...
	public void doSave(IProgressMonitor monitor) 
	{
		...
		if(isNew)
			NetActivator.getDefault().sendAddMessage(Disease.ID, disease);
		else
			NetActivator.getDefault().sendUpdateMessage(Disease.ID, disease);
	}
