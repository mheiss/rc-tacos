...
public class SQLQueries {
	...
	// the properties file
	public static final String QUERIES_BUNDLE_PATH = "at.rc.tacos.server.dbal.sqlqueries";
	// the shared instance
	...
	/**
	 * Returns the query identified by the given queryName in the
	 * queries.properties file.
	 * 
	 * @param key
	 *            the name of the key to get the query for
	 * @return the query value or null if the queryName is not defined in the
	 *         properties file
	 */
