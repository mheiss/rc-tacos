...
import at.rc.tacos.platform.iface.IConnectionStates;
import at.rc.tacos.platform.model.DayInfoMessage;
import at.rc.tacos.platform.model.Login;
import at.rc.tacos.platform.model.Message;
...
public class SessionManager extends PropertyManager implements PropertyChangeListener
{
	...
	public void propertyChange(PropertyChangeEvent event) {
		if("NET_CONNECTION_LOST".equalsIgnoreCase(event.getPropertyName())) {
			fireConnectionLost();
		}
		
		if("NET_TRANSFER_FAILED".equalsIgnoreCase(event.getPropertyName())) {
			final Message info = (Message)event.getNewValue();
