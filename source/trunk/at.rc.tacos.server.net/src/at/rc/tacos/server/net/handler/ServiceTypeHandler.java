...
public class ServiceTypeHandler implements Handler<ServiceType> {
    ...
    @Override
    public void add(ServerIoSession session, Message<ServiceType> message) throws ServiceException,
            SQLException {
    ...
    @Override
    public void get(ServerIoSession session, Message<ServiceType> message) throws ServiceException,
            SQLException {
    ...
    @Override
    public void remove(ServerIoSession session, Message<ServiceType> message)
    ...
    @Override
    public void update(ServerIoSession session, Message<ServiceType> message)
            throws ServiceException, SQLException {
        List<ServiceType> serviceList = message.getObjects();
        // loop and remove the service object
        for (ServiceType service : serviceList) {
    ...
    @Override
    public void execute(ServerIoSession session, Message<ServiceType> message)
            throws ServiceException, SQLException {
