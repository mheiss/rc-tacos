...
public class NotifyDetailHandler implements Handler<CallerDetail> {
    ...
    @Override
    public void add(ServerIoSession session, Message<CallerDetail> message)
    ...
    @Override
    public void get(ServerIoSession session, Message<CallerDetail> message)
            throws ServiceException, SQLException {
        // the params
    ...
    @Override
    public void remove(ServerIoSession session, Message<CallerDetail> message)
            throws ServiceException, SQLException {
    ...
    @Override
    public void update(ServerIoSession session, Message<CallerDetail> message)
            throws ServiceException, SQLException {
        List<CallerDetail> callerList = message.getObjects();
    ...
    @Override
    public void execute(ServerIoSession session, Message<CallerDetail> message)
            throws ServiceException, SQLException {
        // throw an execption because the 'exec' command is not implemented
