 ...
 * </p>
 * <p>
 * The decoded line of text will be parser with {@link XStream2} to convert it to a higher level
 * object and then passed to the {@link IoHandler} instance.
 * </p>
 * 
 * @author Michael
 */
    ...
    protected void writeText(IoSession session, String text, ProtocolDecoderOutput out) {
        ...
        try {
            ...
            if (!(message instanceof AbstractMessage)) {
                logAndThrowException("Can only send messages from type 'AbstractMessage' is "
                        + message == null ? "null" : message.getClass().getName(), null);
            }
