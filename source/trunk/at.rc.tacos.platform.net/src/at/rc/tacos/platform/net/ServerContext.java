...
/**
 * Interface definition for a server context. Provides access to the resource and service
 * implementations of the current running server instance.
 * 
 * @author Michael
 */
public interface ServerContext {
    ...
    /**
     * Returns the handler factory that holds the available handler implementation
     * 
    ...
    /**
     * Returns the service factory to holds the available dbal service implementations
     * 
