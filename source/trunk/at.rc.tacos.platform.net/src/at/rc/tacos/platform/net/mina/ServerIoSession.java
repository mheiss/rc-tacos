...
public class ServerIoSession implements IoSession {
     ...
     * interaction with the {@link Handler} and the {@link Service} instances and sends the result
     * back to the client who sends the request.
     * <p>
     * To send a message to all connected clients use the
     * {@link ServerIoSession#writeBrodcast(Message, Object...)} method.
     * </p>
     * 
     * @param message
     ...
     */
    public void write(Message<? extends Object> originalMessage, Object... objects) {
     ...
     * {@link ServerIoSession#write(Message, Object...)} method.
     * </p>
     * 
     * @param message
     *            the original received message from the client
     ...
     * <p>
     * Use the specialized {@link ServerIoSession#write(Message, Object...)} and the
     * {@link ServerIoSession#writeBrodcast(Message, Object...)} to create and send valid messages.
     * </p>
     * 
     * @see IoSession#write(Object)
     * @see ServerIoSession#write(Message, Object...)
     * @see ServerIoSession#writeBrodcast(Message, Object...)
     */
    @Override
    ...
    /**
     * This is the default implementation of the mina write method. Use the specialized
     * {@link ServerIoSession#write(Message, Object...)} and the
     * {@link ServerIoSession#writeBrodcast(Message, Object...)} to create and send valid messages.
     * 
