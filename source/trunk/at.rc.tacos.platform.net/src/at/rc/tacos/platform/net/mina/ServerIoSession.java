...
public class ServerIoSession implements IoSession {
	 ...
	 * <p>
	 * Use the specialized {@link ServerIoSession#write(Message, Object...)} and
	 * the {@link ServerIoSession#writeBrodcast(Message, Object...)} to create
	...
	/**
	 * This is the default implementation of the mina write method. Use the
	 * specialized {@link ServerIoSession#write(Message, Object...)} and the
	 * {@link ServerIoSession#writeBrodcast(Message, Object...)} to create and
	 * send valid messages.
	 * 
