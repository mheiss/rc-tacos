...
public class RosterEntryManager extends PropertyManager {
	 ...
	 * 
	 * @param newRosterEntry
	 *            the roster entry to check
	 */
	...
	/**
	 * Informs the views that the selected date in the roster view filter has
	 * changed.
	 * 
	 * @param newDate
	...
	/**
	 * Returns a list of all checked in roster entries by location within two
	 * days so two days after the planned end of the entry the member can't
	 * longer be assigned to a vehicle
	 * 
	 * @param location
	...
	/**
	 * Returns the roster entry for the given (checked in) StaffMember or null
	 * if there is no entry for the staffMemberId
	 * 
	 * @param staffMember
	...
	/**
	 * Returns the date of the currently displayed entry choosen by the filter
	 * view.
	 * 
