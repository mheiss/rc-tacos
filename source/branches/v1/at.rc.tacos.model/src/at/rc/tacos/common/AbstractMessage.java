...
public abstract class AbstractMessage {
	 ...
	 * 
	 * @param id
	 *            the uniq identification of this object
	 */
	 ...
	 * 
	 * @param propertyName
	 *            the name of the interested property
	 * @param listener
	 *            the listener to attach
	 */
	 ...
	 * 
	 * @param propertyName
	 *            the property to remove from the listener list
	 * @param listener
	 *            the listener to remove
	 */
	...
	/**
	 * Fired when a property has changed the value and so the ui must be updated
	 * to reflect the actual model.
	 * 
	 * @param propertyName
