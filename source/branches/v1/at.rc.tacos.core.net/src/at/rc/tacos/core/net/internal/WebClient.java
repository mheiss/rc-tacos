 ...
 * Provides convienient methods to prevent the encoding and decoding of the
 * objects from and to xml.<br>
...
public class WebClient {
	 ...
	 * @return the result of the login process or a system message in case of an
	 *         error
	 */
	 ...
	 * 
	 * @return the result of the logout process or a system message in case of
	 *         an error
	 */
	...
	/**
	 * Sends a request to add the given object to the server. If the object was
	 * added successfully the server will send the object back.
	 * 
	 * @param contentType
	 *            the type of the <code>messageObject</code>. Example
	 *            <code>RosterEntry.ID</code>
	 * @param addObject
	 *            the object to be added to the server To get the more details
	 *            about the response the following methods can be used.
	 *            <ul>
	 *            <li><code>getContentType</code> returns the type of the
	 *            content</li>
	 *            <li><code>getQueryString</code> returns the queryString</li>
	 *            <li><code>getUserId</code> returns the user name who send the
	 *            query</li>
	 *            <li><code>getTimestamp</code> returns the timestamp of the
	 *            query</li>
	 *            </ul>
	...
	/**
	 * Sends a request to remove the given object from the server. If the object
	 * was removed successfully the server will send the old object back.
	 * 
	 * @param contentType
	 *            the type of the <code>messageObject</code>. Example
	 *            <code>RosterEntry.ID</code>
	 * @param removeObject
	 *            the object to be removed from the server To get the more
	 *            details about the response the following methods can be used.
	 *            <ul>
	 *            <li><code>getContentType</code> returns the type of the
	 *            content</li>
	 *            <li><code>getQueryString</code> returns the queryString</li>
	...
	/**
	 * Sends a request to update the given object to the server. If the object
	 * was added successfully the server will send the updated object back.
	 * 
	 * @param contentType
	 *            the type of the <code>messageObject</code>. Example
	 *            <code>RosterEntry.ID</code>
	 * @param updateObject
	 *            the object to be updated on to the server To get the more
	 *            details about the response the following methods can be used.
	 *            <ul>
	 *            <li><code>getContentType</code> returns the type of the
	 *            content</li>
	 ...
	 * 
	 * @param contentType
	 *            the type of the object to get a listing from
	 * @param queryFilter
	 *            the filter to apply to this request. Example: Request a
	 *            listing of objects from a specifiy id To get the more details
	 *            about the response the following methods can be used.
	 *            <ul>
	 *            <li><code>getContentType</code> returns the type of the
	 *            content</li>
	 ...
	 * @param contentType
	 *            the type of the <code>messageObject</code>.
	 * @param queryString
	 *            the query that should be done on the server.
	 * @param queryFilter
	 *            the filter to apply
	 * @param messageObject
	 ...
	 */
	private List<AbstractMessage> sendRequest(String userId, String contentType, String queryString, QueryFilter queryFilter, AbstractMessage messageObject) {
		// set up the factory
		factory = new XMLFactory();
	 ...
	 * This means that the returned content contains <code>RosterEntry</code>
	 * objects.
	 * 
