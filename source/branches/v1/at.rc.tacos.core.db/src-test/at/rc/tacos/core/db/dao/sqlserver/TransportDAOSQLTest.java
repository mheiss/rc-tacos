...
public class TransportDAOSQLTest extends DBTestBase {
	...
	private final TransportDAO transportDAO = DaoFactory.SQL.createTransportDAO();
	...
	public void setUp() throws SQLException {
		...
		transport1 = new Transport("vonStraﬂe1", "vonStadt1", location1, MyUtils.stringToTimestamp("28-01-2008", MyUtils.dateFormat), MyUtils
				.stringToTimestamp("28-01-2008 12:00", MyUtils.timeAndDateFormat), "A", 2);
		transport2 = new Transport("vonStraﬂe2", "vonStadt2", location2, MyUtils.stringToTimestamp("28-01-2008", MyUtils.dateFormat), MyUtils
				.stringToTimestamp("28-01-2008 14:00", MyUtils.timeAndDateFormat), "B", 2);
	...
	public void testInsertTransport() throws SQLException {
		...
		{
			Transport transport3 = new Transport("vonStraﬂe3", "vonStadt3", location1, MyUtils.stringToTimestamp("29-01-2008", MyUtils.dateFormat),
					MyUtils.stringToTimestamp("29-01-2008 14:00", MyUtils.timeAndDateFormat), "C", 2);
	...
	public void testUpdateTranpsport() throws SQLException {
		{
			...
			// transport.setVehicleDetail(veh1); --> to set a vehicle is only
			// possible in combination with generating
			// a transport number (there the vehicle is written into the
			// database
	...
	public void testGenerateTransportNumber() throws SQLException {
		...
		// second transport - same vehicle/same location -->higher transport
		// number
	...
	public void testUpdateAssignedTransport() throws SQLException {
		// veh2 = new VehicleDetail("KA02","KTW",location2, location1, phone2,
		// "vehicle notes...", false, true);
