...
public class RosterDAOSQLTest extends DBTestBase {
	...
	public void setUp() throws SQLException {
		...
		entry1 = new RosterEntry(member1, serviceType1, job1, location1, MyUtils.stringToTimestamp("28-01-2008 10:00", MyUtils.timeAndDateFormat),
				MyUtils.stringToTimestamp("28-01-2008 15:00", MyUtils.timeAndDateFormat));
		entry2 = new RosterEntry(member2, serviceType2, job2, location2, MyUtils.stringToTimestamp("28-01-2008 12:00", MyUtils.timeAndDateFormat),
				MyUtils.stringToTimestamp("28-01-2008 18:00", MyUtils.timeAndDateFormat));
		// insert test data
