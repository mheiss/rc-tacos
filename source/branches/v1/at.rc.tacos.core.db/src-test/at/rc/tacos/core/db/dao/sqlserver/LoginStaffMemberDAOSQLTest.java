...
//
/**
 * This is a test class to test the functionality of the staffMember and the
 * login class. The test are combined because the two daos cannot be tested
 * alone
 * 
 * @author Walter
 */
public class LoginStaffMemberDAOSQLTest extends DBTestBase {
