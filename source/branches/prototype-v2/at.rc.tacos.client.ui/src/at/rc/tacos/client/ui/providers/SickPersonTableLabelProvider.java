	...
	public String getColumnText(Object element, int columnIndex) {
		...
		switch (columnIndex) {
			...
			case COLUMN_TA:
				...
				if (person.getKindOfTransport().equalsIgnoreCase(IKindOfTransport.TRANSPORT_KIND_TRAGSESSEL))
					return "S";
				if (person.getKindOfTransport().equalsIgnoreCase(IKindOfTransport.TRANSPORT_KIND_KRANKENTRAGE))
					return "L";
				if (person.getKindOfTransport().equalsIgnoreCase(IKindOfTransport.TRANSPORT_KIND_GEHEND))
					return "G";
				if (person.getKindOfTransport().equalsIgnoreCase(IKindOfTransport.TRANSPORT_KIND_ROLLSTUHL))
					return "R";
				return "";
			case COLUMN_NOTES:
