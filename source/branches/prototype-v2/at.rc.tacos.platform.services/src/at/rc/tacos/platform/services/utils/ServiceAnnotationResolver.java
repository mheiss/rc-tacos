...
/**
 * Provides methods to resolve the {@link Service} annotations and use reflection to set up the
...
public class ServiceAnnotationResolver extends AnnotationResolver {
    ...
    private DbalServiceFactory factory;

    /**
     * Default class constructor to handle @link {@link Service} annotations. The @link
     * {@link DbalServiceFactory} will be used to resolve the services that are referenced by the
     * annotations.
     * 
     * @param factory
     *            the factory to resolve the annotation reference
     */
    public ServiceAnnotationResolver(DbalServiceFactory factory) {
        super(Service.class);
        this.factory = factory;
    }

    @Override
    protected Object annotationFound(Field field, Annotation annotation, Object currentInstance)
            throws Exception {
