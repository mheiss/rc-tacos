...
public interface UserLoginDAO {
	...
	/**
	 * It is not possible to log in if the user has not the compentence
	 * 'Leitstellendisponent' This represents the value -3
	 */
	public final static int LOGIN_NO_DISPONENT = -3;

	/**
	 * Adds a new login to the database. his method will <b>NOT</b> create the
	 * staff member. Please use the <code>StaffMemberDAO.addStaffMember</code>
	 * to create a staff member for the login<br>
	 * 
	 * @param login
	...
	/**
	 * Updates a login information in the database. This method will <b>NOT</b>
	 * update the staff member. Please use the
	 * <code>StaffMemberDAO.updateStaffMember</code> to update the staff
	 * member.!<br>
	 ...
	 *            the user to update
	 * @param newPwd
	 *            the hash value of the new password
	...
	/**
	 * lockes a login no login will be possible for this user
	 * 
	 * @param username
	...
	/**
	 * unlockes a login login will be possible again for this user
	 * 
	 * @param username
	 ...
	 * @return <code>UserDAO.LOGIN_SUCCESSFULL</code> if the authentication was
	 *         successfull <code>UserDAO.LOGIN_FAILED</code> if password or
	 *         username was wrong <code>UserDAO.LOGIN_DENIED</code> if the user
	 *         is locked
	 */
	 ...
	 * 
	 * @param username
	 *            the username to get the login from
