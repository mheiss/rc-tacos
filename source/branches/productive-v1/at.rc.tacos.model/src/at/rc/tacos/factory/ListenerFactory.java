...
public class ListenerFactory {
	 ...
	 * 
	 * @param id
	 *            the purpose to register the listener
	 * @param listener
	 *            the listener to add
	 */
	 ...
	 * 
	 * @param id
	 *            the purpose of the register to remove
	 */
	 ...
	 * 
	 * @param id
	 *            the message to get the listener
	...
	/**
	 * Convenience method to check if this type of message has a listener or
	 * not.
	 * 
	 * @param id
	 *            the message to check for listeners
