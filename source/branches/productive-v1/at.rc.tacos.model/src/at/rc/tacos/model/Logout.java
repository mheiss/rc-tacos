 ...
 * In case of a failed logout request the error message can be retrieved with
...
public class Logout extends AbstractMessage {
	...
	/**
	 * Returns whether the user logout was successfully or not. This field will
	 * be set by the server, if the logout was not successfully the
	 * <code>getErrorMessage</code> can be used to get the error message.
	 * 
	 ...
	 * 
	 * @param username
	 *            the username of the staff member to logout
	 ...
	 * 
	 * @param loggedOut
	 *            true if the logout was successfully, otherwise false.
	 */
	 ...
	 * 
	 * @param errorMessage
	 *            the cause of the logout failure
	 * @throws IllegalArgumentException
	 *             if the error message is null or empty
	 */
