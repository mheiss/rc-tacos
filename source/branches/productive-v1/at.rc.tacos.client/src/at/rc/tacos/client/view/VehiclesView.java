...
/**
 * GUI to get an overview about the ambulances create CarComposite's using the
 * CarCompositeManager
 * 
 * @author b.thek
 */
public class VehiclesView extends ViewPart implements PropertyChangeListener {
	 ...
	 * 
	 * @param parent
	 *            the parent frame to insert the controlls
	 */
	@Override
	...
	/**
	 * Notification that the data model has changed so the view have to be
	 * updated.
	 * 
	 * @param evt
	 *            the fired property event
	 */
	 ...
	 * 
	 * @param form
	 *            the form to add the section
	 * @param toolkit
	 *            the toolkit to create the client component
	 * @param title
	...
	private Section createSection(Form form, FormToolkit toolkit, String title, String description) {
		// Create the section
		Section section = toolkit.createSection(form.getBody(), ExpandableComposite.TWISTIE | ExpandableComposite.COMPACT
	 ...
	 * 
	 * @param stationComposite
	 *            the composite to add to
	 * @param vehicle
	 *            the vehicle to add
	 */
	...
	/**
	 * Updates the description in the vehicle section to show the vehicles that
	...
	private void updateSection(Section section) {
		...
		section.setDescription("Zur Zeit sind in " + location.getLocationName() + " " + vehicleList.size()
				+ " Fahrzeuge einsatzbereit von insgesammt " + numOfVehicles);
	}
