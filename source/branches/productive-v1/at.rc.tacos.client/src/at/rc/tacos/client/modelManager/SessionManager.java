...
/**
 * This class manages the logged in user and the data accociated with the
 * current session. The day info message is also managed here.
 * 
 * @author Michael
 */
public class SessionManager extends PropertyManager {
	 ...
	 * 
	 * @param the
	 *            login information or null if no user is authenticated
	 */
	...
	public void setDayInfoMessage(final DayInfoMessage dayInfo) {
		// check if current displayed date is equal to the date of the day info
		// update message
