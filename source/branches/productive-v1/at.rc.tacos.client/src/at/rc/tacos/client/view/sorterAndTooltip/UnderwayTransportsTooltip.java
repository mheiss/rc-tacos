...
//
// /**
// * This shows the tool tip for the transports of the underway (disponierte)
// transports view
// * @author b.thek
// */
...
//        
// Image image =
// ImageFactory.getInstance().getRegisteredImage("transport.directness");
// String title = transport.getFromStreet() +"/" +transport.getFromCity() +" "
// +transport.getPatient().getLastname() +" "
// +transport.getPatient().getFirstname() +" "
...
// else
// term = "";
// if((!plannedStartTime.equalsIgnoreCase("") ||
// !plannedTimeAtPatient.equalsIgnoreCase("") || !term.equalsIgnoreCase("")))
// {
...
// {
// image =
// ImageFactory.getInstance().getRegisteredImage("transport.callerDetail");
// title = transport.getCallerDetail().getCallerName() +" "
// +transport.getCallerDetail().getCallerTelephoneNumber();
// addIconAndLabel(composite,image,title);
// }
//		
// //notified
// if (!(emergencyDoctor.equalsIgnoreCase("") ||
// helicopter.equalsIgnoreCase("")|| police.equalsIgnoreCase("") ||
// brkdt.equalsIgnoreCase("")|| df.equalsIgnoreCase("")
// || firebrigade.equalsIgnoreCase("")))
// {
// image =
// ImageFactory.getInstance().getRegisteredImage("transport.exclamation");
// title = emergencyDoctor +" " +helicopter +" " +police +" " +brkdt +" " +df
// +" "+firebrigade +mountainRescue;
// addIconAndLabel(composite,image,title);
// }
//		
// if(transport.isEmergencyPhone())
