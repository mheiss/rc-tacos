...
public interface SickPersonDAO
{
	 ...
	 * @param sickPerson the sickPerson to add
	 ...
	 * @param sickPerson the sickPerson to update
	 ...
	 * @param id the sickPerson to remove
	 * @return true if the removal was successfully
	 */
	public boolean removeSickPerson(int id) throws SQLException;
	
	/**
	 * Returns a list of all sick persons in the database if the last name contains the lastNameSubString.
	 ...
	 * @param id the id of the sick person to get
